locals {
  ...
  database_instance = "${var.instance == "" ? google_sql_database_instance.this.self_link : var.instance }"

  // The database instance name
  database_instance_name = "${var.instance_name == "" ? google_sql_database_instance.this.name : var.instance_name }"
